      ...
      >
        <Row gutter={24}>
          <Col span={8}>
            ...
            <span style={{ padding: '4px 12px', background: 'rgba(67,233,123,0.1)', border: '1px solid rgba(67,233,123,0.2)', borderRadius: 6, color: '#389e0d', fontSize: 12, fontWeight: 500 }}>是</span>
          </Col>
          <Col span={16}>
            <Text type="secondary" style={{ fontSize: 12, display: 'block', marginBottom: 6 }}>品牌名称</Text>
            <Space size={8}>
              <span style={{ padding: '4px 12px', background: 'rgba(102,126,234,0.05)', border: '1px solid rgba(102,126,234,0.2)', borderRadius: 6, color: '#667eea', fontSize: 12, fontWeight: 500 }}>GreenLife</span>
              <span style={{ padding: '4px 12px', background: 'rgba(102,126,234,0.05)', border: '1px solid rgba(102,126,234,0.2)', borderRadius: 6, color: '#667eea', fontSize: 12, fontWeight: 500 }}>OutdoorPro</span>
            </Space>
          </Col>
        </Row>
      </Card>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, flex: 1 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <Text strong style={{ fontSize: 14 }}>环保材料应用技术</Text>
                <span style={{ fontSize: 12, color: '#888' }}>
                  专利号: <span style={{ fontFamily: 'monospace' }}>ZL2023XXXXXXXX.X</span>
                </span>
                <span style={{ padding: '2px 8px', background: 'rgba(67,233,123,0.1)', borderRadius: 4, color: '#389e0d', fontSize: 12 }}>发明专利</span>
              </div>
            </div>
            <Space size={4}>
              <Button type="link" size="small" icon={<EditOutlined />} onClick={() => onEditPatent({ name: '环保材料应用技术', patent_no: 'ZL2023XXXXXXXX.X', type: '发明专利' })}>编辑</Button>
              <Button type="link" size="small" danger icon={<DeleteOutlined />} onClick={() => onDeletePatent('环保材料应用技术')}>删除</Button>
            </Space>
          </div>
          <div style={{
            display: 'flex', alignItems: 'center', justifyContent: 'space-between',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, flex: 1 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                <Text strong style={{ fontSize: 14 }}>可折叠户外家具结构设计</Text>
                <span style={{ fontSize: 12, color: '#888' }}>
                  专利号: <span style={{ fontFamily: 'monospace' }}>ZL2024XXXXXXXX.X</span>
                </span>
                <span style={{ padding: '2px 8px', background: 'rgba(102,126,234,0.1)', borderRadius: 4, color: '#667eea', fontSize: 12 }}>实用新型</span>
              </div>
            </div>
            <Space size={4}>
              <Button type="link" size="small" icon={<EditOutlined />} onClick={() => onEditPatent({ name: '可折叠户外家具结构设计', patent_no: 'ZL2024XXXXXXXX.X', type: '实用新型' })}>编辑</Button>
              <Button type="link" size="small" danger icon={<DeleteOutlined />} onClick={() => onDeletePatent('可折叠户外家具结构设计')}>删除</Button>
            </Space>
          </div>
        </Space>
      </Card>
