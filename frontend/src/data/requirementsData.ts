...
export const dimensions: Dimension[] = [
  {
    ...
    multiple: true,
    options: [
      { value: 'production', label: '生产型', description: '以自有工厂、制造、加工、生产为主' },
      { value: 'trading', label: '贸易型', description: '以采购、销售、进出口、渠道分销为主' },
      { value: 'factoryTrading', label: '工贸一体', description: '既有生产能力，又有贸易渠道' },
      { value: 'crossBorderSeller', label: '跨境卖家型', description: '以平台运营、独立站、品牌零售为主' },
      { value: 'brandOperator', label: '品牌运营型', description: '以品牌建设、营销推广、渠道运营为核心' },
      { value: 'supplyChainService', label: '供应链服务型', description: '以物流、报关、仓配、供应链整合为主' },
      { value: 'technicalService', label: '技术服务型', description: '以软件、系统、技术方案或技术产品为主' },
      { value: 'comprehensiveService', label: '综合服务型', description: '以代运营、咨询、培训、传媒、设计等服务为主' },
      { value: 'undefined', label: '未定义', description: '暂时无法准确归类，待进一步确认' },
    ],
  },
  {
    key: 'targetMode',
