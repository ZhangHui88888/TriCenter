...
> 常州跨境电商三中心 — 企业信息管理系统（企业CRUD、跟进记录、看板统计、漏斗分析）
...
- **前端**：ESLint，Axios 封装 (`src/utils/request.ts`)
- **API 文档**：Knife4j (Swagger) `http://localhost:8080/doc.html`
