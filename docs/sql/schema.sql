...
CREATE TABLE providers (
    ...
    category                VARCHAR(50) NOT NULL COMMENT '服务分类(关联system_options表,category=provider_category)',
...
CREATE TABLE market_reports (
    ...
    status                VARCHAR(20) DEFAULT 'draft' COMMENT '报告状态: draft/generating/completed/reviewed',
    report_data           JSON COMMENT '报告全部内容（JSON格式，按章节存储）',
    ai_generated_sections VARCHAR(500) COMMENT 'AI已生成的章节列表，逗号分隔',
